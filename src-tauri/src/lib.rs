...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_work_references_for_document,
            commands::create_work_reference,
            commands::delete_work_reference,
            commands::reorder_work_references,
            commands::recheck_work_reference_matches,
            commands::list_document_doi_references_for_document,
            commands::list_document_doi_references_pointing_to_document,
            commands::list_document_keywords,
            commands::replace_document_keywords,
            commands::get_usage_counter,
            commands::set_usage_counter,
            ...
            remote_vault::get_remote_vault_revision,
            remote_vault::renew_remote_vault_lease,
